...
kom=random.choice(["Badru Ganteng:)","Lo Ganteng Boss :v","Yang Posting Orang Nya Ganteng:)","Mantap:v","Be Yourself And Never Surrentod:v","Keren Bro Script Nya:)","Hi I'm mbf-fb User ^_^"])
class ganteng:
